          ...
          <div className="border border-zinc-400 rounded-xl px-5 max-w-[700px] my-10 p-4">
            ...
            <div className="w-full my-2">
              <button
                ...
                className="w-full justify-center px-4 py-3 border flex gap-3 bg-gray-50  border-slate-400 rounded-lg text-slate-700 hover:border-slate-400 hover:text-slate-900 hover:shadow transition duration-150"
              >
                <img
                  className="w-6 h-6"
